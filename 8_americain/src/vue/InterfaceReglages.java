...
public class InterfaceReglages {
	...
	public InterfaceReglages(JFrame uneFrame) {
		...
		initialize();
		new ControleurReglages(ordis, difficults, Valider, positif, negatif, textField, Partie.getPartie(), list,
				frame);
	}
	...
	private void initialize() {
		...
		Valider.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				maVariante.setVariante((String) list.getSelectedValue());
				System.out.println(maVariante.getVarianteEnCours());
				frame.getContentPane().removeAll();
				frame.repaint();
				// new InterfaceManche(frame,manche); //on passe a l'interface suivante
			}
		});
