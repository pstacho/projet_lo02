...
public class VueTapisJeu implements Observer {
	...
	piocheTalon.add(pioche);
	 talon = new JLabel();
	ImageIcon carteTalon = new ImageIcon("images/cartes/"+laManche.getLeTalon().getCarteDessus().getValeur()+"_"+laManche.getLeTalon().getCarteDessus().getCouleur()+".png");
	...
	while (parcourirCarteJoueur.hasNext()) {
		...
		ImageIcon imageCarte = new ImageIcon("images/cartes/"+prochaineCarte.getValeur()+"_"+prochaineCarte.getCouleur()+".png");
	...
	//	moi.trierCartes();
		...
		for (int i = 0; i < moi.getMainJoueur().size(); i++) {
			JButton carte = new JButton(new ImageIcon("images/cartes/"+moi.getMainJoueur().get(i).getValeur()+"_"+moi.getMainJoueur().get(i).getCouleur()+".png"));
	...
	*/
	...
	public void update(Observable instanceObservable, Object arg1) {
		...
		if (instanceObservable instanceof Joueur) {
			...
			ImageIcon imageCarte = new ImageIcon("images/cartes/"+laManche.getLeTalon().getCarteDessus().getValeur()+"_"+laManche.getLeTalon().getCarteDessus().getCouleur()+".png");
			this.talon.setIcon(imageCarte);
			if (instanceObservable instanceof JoueurPhysique) {
				if (arg1 != null) {
				if (arg1.equals("a joué")) {
					...
					while (parcourirCarteJoueur.hasNext()) {
						Carte prochaineCarte = (Carte) parcourirCarteJoueur.next();
						JButton bouttonProchaineCarte = new JButton();
						ImageIcon imageCarte2 = new ImageIcon("images/cartes/"+prochaineCarte.getValeur()+"_"+prochaineCarte.getCouleur()+".png");
